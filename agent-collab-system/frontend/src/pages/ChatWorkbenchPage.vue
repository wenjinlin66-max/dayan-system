  ...
  <div class="min-h-screen bg-[linear-gradient(180deg,#edf3fb_0%,#f8fbff_44%,#eef2f7_100%)] p-6 text-slate-900">
    ...
    <div class="overflow-hidden rounded-[30px] border border-slate-200/80 bg-white/95 shadow-[0_28px_80px_rgba(15,23,42,0.10)]">
      ...
      <div class="grid gap-4 px-6 py-5 xl:grid-cols-[320px_minmax(0,1.45fr)_300px]">
        ...
        <div class="min-w-0 rounded-[28px] border border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] p-4 shadow-[0_24px_60px_rgba(148,163,184,0.12)]">
          <ChatWindow />
...
import ExecutionResultCard from '@/components/chat/ExecutionResultCard.vue'
