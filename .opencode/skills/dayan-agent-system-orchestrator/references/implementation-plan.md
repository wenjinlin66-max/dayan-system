...
- 核心任务：
  ...
  11. 执行型智能体优先打通“对话审批 + 结果回传”主链
  12. 决策型智能体补齐规则集、模型注册、LLM+RAG 三模式运行链路
  13. 对话型智能体补齐 workflow registry 检索、歧义消解、部门隔离与多模态归一化主链
  14. 控制节点逐步实现 condition / approval / wait / exception 的运行时主链
- 交付物：
  - 五类智能体 handler 初版
- 三级记忆骨架
